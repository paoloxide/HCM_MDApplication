...
public class ManageDepartmentsTest extends BaseTest{
	...
	public void createDepartment() throws Exception{
		...
		//String cookie = CookieUtilities.getCookie("lkey");
		...
		TaskUtilities.customWaitForElementVisibility("//a[text()='"+searchData+"']", MAX_TIME_OUT, new CustomRunnable() {
